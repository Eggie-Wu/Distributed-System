...
//					for(int i =0;i<20;i++){
//						taskNodeName = zk.create("/dist42/tasks/task-", dTaskSerial, Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT_SEQUENTIAL);
//						System.out.println("Task node created: " + taskNodeName);
//						//Place watch for the result znode which will be created under our task znode.
//						zk.exists(taskNodeName+"/result", this, this, null);
//					}
					taskNodeName = zk.create("/dist42/tasks/task-", dTaskSerial, Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT_SEQUENTIAL);
					System.out.println("\n\nTask node created: " + taskNodeName);
					//Place watch for the result znode which will be created under our task znode.
					zk.exists(taskNodeName+"/result", this, this, null);
				}
		...
		{
			System.out.println("Task node result received: " + e.getPath());
	...
	public void processResult(int rc, String path, Object ctx, byte[] data, Stat stat)
	{
		...
		zk.delete(taskNodeName+"/assigned", -1, null, null);
	...
	public static void main(String args[]) throws Exception
	{
		...
		System.out.println("The result is: "+mcpi.getPi());
