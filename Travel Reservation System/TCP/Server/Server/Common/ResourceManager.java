...
public class ResourceManager
{
	...
	public boolean reserve_car_server(int id, String location) {
	...
	public boolean reserve_room_server(int id, String location) {
	...
	public boolean reserve_flight_server(int id, int flightnumber) {
	...
	public boolean removeReservation(String key, int id, int customerID, int count) {
	...
	public String generate_summary(int id){
		String res = "";
	...
	public String generate_analytics(int id, int lowquantity){
		String res = "";
