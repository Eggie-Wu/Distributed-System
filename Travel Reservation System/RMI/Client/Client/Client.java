	...
	public void execute(Command cmd, Vector<String> arguments) throws RemoteException, NumberFormatException
	{
		switch (cmd)
		{
			...
			case test:{
				...
				//flight
				b=m_resourceManager.addFlight(1,1,10,15);
				printResult(1,b.toString(),"true");

				i=m_resourceManager.queryFlight(1,1);
				printResult(2,Integer.toString(i),"10");

				i=m_resourceManager.queryFlightPrice(1,1);
				printResult(3,Integer.toString(i),"15");

				b=m_resourceManager.addFlight(1,1,20,25);
				printResult(4,b.toString(),"true");

				i=m_resourceManager.queryFlight(1,1);
				printResult(5,Integer.toString(i),"30");

				i=m_resourceManager.queryFlightPrice(1,1);
				printResult(6,Integer.toString(i),"25");

				b=m_resourceManager.newCustomer(1,1);
				printResult(31,b.toString(),"true");
				s=m_resourceManager.queryCustomerInfo(1,1);
				printResult(32,s,"0");

				b=m_resourceManager.reserveFlight(1,1,1);
				printResult(33,b.toString(),"true");
				i=m_resourceManager.queryFlight(1,1);
				printResult(34,Integer.toString(i),"29");
				s=m_resourceManager.queryCustomerInfo(1,1);
				printResult(35,s,"25");

				b=m_resourceManager.deleteCustomer(1,1);
				printResult(36,b.toString(),"true");
				i=m_resourceManager.queryFlight(1,1);
				printResult(37,Integer.toString(i),"30");
				b=m_resourceManager.deleteFlight(1,1);
				printResult(38,b.toString(),"true");
				break;
			}
			case Quit:
