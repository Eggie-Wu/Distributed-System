...
maxmoves=100 interval=50 randseed=50
#TODO IF (and only if) you want to simulate failures, enable this for corresponding player numbers.
#export failmode_2=RECEIVEPROPOSE
#export failmode_3=AFTERSENDVOTE
#export failmode_4=AFTERSENDPROPOSE
#export failmode_5=AFTERBECOMINGLEADER
