...
export process1=lab2-2:501$group
export process2=lab2-8:502$group
export process3=lab2-10:503$group
export process4=lab2-1:504$group
export process5=lab2-11:505$group
#export process6=server6:506$group
#export process7=server7:507$group
#export process8=server8:508$group
#export process9=server9:509$group
